                                ...
                                TextButton(
                                  ...
                                  onPressed: () async {
                                    if (todoController.text.isEmpty) {
                                      showSnackBar(
                                          context, 'Please enter todo first');
                                    } else {
                                      String currentUserUsername = context
                                          .read<UserService>()
                                          .currentUser
                                          .username;
                                      Todo todo = Todo(
                ...
                child: Padding(
                  ...
                  child: Consumer<TodoService>(
                    builder: (context, value, child) => ListView.builder(
                      itemCount: value.todoes.length,
                      itemBuilder: (context, index) {
                        return TodoCard(
                          todo: value.todoes[index],
                          //  To do(
                          //     username: '${value.todoes[index].username}',
                          //     title: '${value.todoes[index].title}',
                          //     created: value.todoes[index].created),
                        );
                      },
                    ),
                  ),
      ...
      child: Slidable(
        ...
        child: CheckboxListTile(
          ...
          onChanged: (value) async {
            String result = await context.read<TodoService>().toggle(todo);
            if (result != 'OK') {
              showSnackBar(context, result);
            }
          },
